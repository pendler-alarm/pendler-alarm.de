    ...
    dashboard: {
      ...
      events: {
        ...
        currentLocation: {
          ...
          sourceCd: 'Train location via CD WiFi',
          locationSource: 'Source: {value}',
          mapTitle: 'Map view',
          mapOpen: 'Open map',
          mapCoordinates: 'Coordinates: {value}',
          mapUnavailable: 'No coordinates are available for this starting point yet.',
          routeTitle: 'Current train route',
          routeSubtitle: 'Live detected via zug.wifi',
          routeFallback: 'As soon as zug.wifi is detected, the current route with live position will appear here.',
          routeCurrentStop: 'Current location',
          routeEtaLabel: 'To {station}',
          routeEtaValue: 'about {value} min',
          routeEtaUnavailable: 'Time to the next station is being estimated',
          routeLiveBadge: 'Live',
          carrierCdName: 'Ceske drahy',
          carrierLabel: 'Connected to {value} WiFi',
          trainNameLabel: 'Train: {value}',
