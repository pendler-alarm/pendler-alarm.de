...
export const de = {
  ...
  views: {
    ...
    about: {
      ...
      storyBodyOne: 'Wir sind Robert (Software Developer), Abdullahi (Datenmanager bei der NVBW) und Johannes (Lokführer bei der Bahn) und haben uns beim Anschluss-Erreichen-Hackathon 2026 zusammengefunden.',
      ...
      visionBodyOne: 'Unsere Vision ist ein leicht zu bedienender Helfer für Pendler*innen und Nutzer*innen des ÖPNV, der anhand verschiedener Kriterien wie Fahrthistorie, Wetter, aktueller Lage und persönlichen Terminen eine realistische Prognose liefert.',
    ...
    privacy: {
      ...
      introBodyOne: 'Pendler Alarm verarbeitet Daten in erster Linie direkt in deinem Browser. Externe Requests entstehen nur dann, wenn du Funktionen wie Kalenderabfrage, Routing, Geocoding, Sharing oder Zugerkennung aktiv nutzt.',
      introBodyTwo: 'Die Listen unten sind an die laufende App gekoppelt. API-Einträge werden aus der Debug-Historie mitgezählt, und Browser-Storage-Einträge zeigen automatisch an, ob auf diesem Gerät bereits Daten gespeichert wurden.',
      ...
      browserStorageBody: 'Diese Schlüssel werden verwendet, um Einstellungen, Caches und lokale Komfortfunktionen im Browser zu speichern. Es werden keine serverseitigen Benutzerprofile aus diesen Daten gebildet.',
