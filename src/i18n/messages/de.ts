  ...
  auth: {
    google: {
      ...
      ical: {
        ...
        placeholder: 'https://posteo.de/calendars/ics/4h371xvn34229m2s3wmpt7s6qxl0084f',
        exampleUrl: 'https://posteo.de/calendars/ics/4h371xvn34229m2s3wmpt7s6qxl0084f',
    ...
    dashboard: {
      ...
      events: {
        ...
        currentLocation: {
          ...
          sourceCd: 'Zugstandort über CD WiFi',
          locationSource: 'Quelle: {value}',
          mapTitle: 'Kartenansicht',
          mapOpen: 'Karte öffnen',
          mapCoordinates: 'Koordinaten: {value}',
          mapUnavailable: 'Für den Startpunkt sind noch keine Koordinaten verfügbar.',
          routeTitle: 'Aktuelle Zugroute',
          routeSubtitle: 'Live erkannt über zug.wifi',
          routeFallback: 'Sobald zug.wifi erkannt wird, erscheint hier die aktuelle Route mit Live-Standort.',
          routeCurrentStop: 'Aktueller Standort',
          routeEtaLabel: 'Bis {station}',
          routeEtaValue: 'ca. {value} Min.',
          routeEtaUnavailable: 'Zeit bis zum nächsten Bahnhof wird berechnet',
          routeLiveBadge: 'Live',
          carrierCdName: 'Ceske drahy',
          carrierLabel: 'Im WLAN von {value}',
          trainNameLabel: 'Zug: {value}',
